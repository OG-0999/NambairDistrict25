    ...
    <section className="py-24 bg-white">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-serif text-[#111111]">AN ELEVATED EXPERIENCE</h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {images.map((img, idx) => (
            <motion.div
              ...
              className="relative aspect-[4/3] overflow-hidden rounded-2xl border border-[#E6E6E6] shadow-[0_18px_40px_rgba(17,17,17,0.08)] group cursor-pointer"
            >
              <img 
                src={img} 
                alt={`Gallery ${idx + 1}`} 
              ...
              <div className="absolute inset-0 bg-white/70 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                <div className="w-12 h-12 rounded-full border border-primary/60 flex items-center justify-center text-primary scale-0 group-hover:scale-100 transition-transform duration-500 delay-100">
                  +
                </div>
              </div>
            </motion.div>
...
export function Amenities() {
  ...
  return (
    <section id="amenities" className="py-24 bg-[#F7F7F5] border-t border-[#E6E6E6] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-serif text-[#111111]">A DISTRICT IN ITSELF</h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {categories.map((cat, idx) => (
            <motion.div
              ...
              className="bg-white border border-[#E6E6E6] rounded-2xl p-6 shadow-[0_16px_36px_rgba(17,17,17,0.08)] hover:-translate-y-1 hover:border-primary/40 hover:shadow-[0_20px_44px_rgba(17,17,17,0.12)] transition-all duration-500 group relative"
            >
              <h3 className="text-xl font-serif text-[#111111] mb-4 group-hover:text-primary transition-colors">{cat.title}</h3>
              <p className="text-[#666666] text-sm leading-relaxed">{cat.items}</p>
...
export function Clubhouse() {
  return (
    <section className="py-0 bg-[#F7F7F5]">
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-transparent to-[#F7F7F5] hidden lg:block"></div>
        </motion.div>
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-serif text-[#111111] leading-tight mb-6">
            THE 7 ACRE CLUBHOUSE
          </h2>
          
          <p className="text-[#444444] text-base font-light leading-relaxed mb-6">
          ...
          <p className="text-[#444444] text-base font-light leading-relaxed mb-10">
          ...
          <button className="bg-white border border-primary/50 text-[#111111] px-7 py-3 font-medium tracking-widest uppercase text-sm transition-all duration-500 hover:bg-primary/15 hover:shadow-[0_12px_30px_rgba(200,169,106,0.25)] w-max">
            Explore Amenities
          </button>
        </motion.div>
      </div>
